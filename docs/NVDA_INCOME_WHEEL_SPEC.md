...
### What expiry
**The third expiry out**, whatever weekday it falls on. NVDA lists Mon/Wed/Fri, so the
third is 6 to 7 days from any starting day and the book holds a rotation of dates.

| write on | third expiry lands | days |
|---|---|---|
| Monday | next Monday | 7 |
| Wednesday | next Wednesday | 7 |
| Friday | next Friday | 7 |

> Measured under the LIVE 15-contract cap. A cash-capped version of this test was
> misleading and was discarded: longer contracts sit in the CONTRACT cap and stop you
> writing, which a cash cap does not model.
>
> | expiry | tenor | premium/yr | avg price paid |
> |---|---|---|---|
> | nearest Friday | 4d | $610,986 | -1.8% vs market |
> | **3 expiries out** | 7d | **$879,322** | **-3.3%** |
> | 4 expiries out | 10d | $764,975 | -3.7% |
>
> Better on premium AND on entry price at once. Four out buys marginally cheaper and
> gives back $114k of premium.
>
> **Every slice must get a full week.** Slicing into the same near expiry was measured
> and fails: the late-week writes are one and two day contracts paying almost nothing.
> It cost income ($1.26m against $1.62m) and cut no risk at all.
>
> **This rule has now been wrong twice, both times for the same reason.** It first said
> "at least 5 days out", carried over from a test that measured ENTRY PRICE while
> accumulation was the goal. Then it said "the coming Friday", right for income on a
> SINGLE unsliced write, which is what that test measured. Neither survived once the
> writes were sliced daily. "First Friday at least 5 days out" also is not what it
> sounds like: from a Monday it jumps to a Friday eleven days away, so the tenor swings
> between 7 and 11 days by weekday.
